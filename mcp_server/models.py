...
#   timestamp: 2025-06-28T15:05:41+00:00
...
class CertificateParameters(BaseModel):
    DOB: str = Field(..., description='Date of Birth', examples=['dd-mm-yyyy'])
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    ROLL: str = Field(..., description='Roll No.', examples=['18110000'])
    YOP: str = Field(..., description='Year of Passing', examples=['2018'])
